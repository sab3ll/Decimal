...
Suite *s21_sub_suite_create() {
  Suite *suite = suite_create("s21_sub_test");
  TCase *tc_core = tcase_create("tcase_core_s21_sub_test");
  ...
  tcase_add_test(tc_core, s21_sub_test_13);
  tcase_add_test(tc_core, s21_sub_test_14);
  tcase_add_test(tc_core, s21_sub_test_15);
  tcase_add_test(tc_core, s21_sub_test_16);
  tcase_add_test(tc_core, s21_sub_test_17);
  tcase_add_test(tc_core, s21_sub_test_18);
  tcase_add_test(tc_core, s21_sub_test_19);
